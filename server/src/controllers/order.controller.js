                ...
                <body>
                    <div class="container">
                        ...
                        <div class="order-details">
                            ...
                            <hr>
                            <p><span class="highlight">Order Total:</span> Rs.${Number(totalAmount).toFixed(2)}</p>
                            <p><span class="highlight">Payment Status:</span> <strong style="color: red;">Pending</strong></p>
                        </div>
