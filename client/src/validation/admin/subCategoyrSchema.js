...
export const addSubCategoryScheme = Yup.object().shape({
    ...
    subCategoryName: Yup.string().required("Sub-Category Name Is Required").min(3, "Sub-Category Atleast Have More Than 3 Characters").matches(/^[A-Za-z\s]+$/, "Sub-Category Name Must Only Contain Letters"),
