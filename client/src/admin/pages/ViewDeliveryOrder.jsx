...
const ViewDeliveryOrder = () => {
    ...
    return (
        <>
            <Helmet>
                <title>View Delivered Order | sameerCart</title>
                <meta name="description" content="Check details of a delivered order in sameerCart admin panel, including customer reviews and feedback." />
