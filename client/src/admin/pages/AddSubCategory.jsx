...
const AddSubCategory = () => {
    ...
    useEffect(() => {
        const UpdateSlug = (name, value) => {
            if (name === "subCategoryName") {
                ...
                setValue("subCategorySlug", transformedSlug, {
                    shouldValidate: true,
                });
            }
        };
    ...
    return (
        <>
            <Helmet>
                <title>Add Subcategory | sameerCart</title>
                <meta name="description" content="Create a new product subcategory in sameerCart admin panel to organize your inventory better." />
