...
const TestimonailsData = [
    { id: 1, image: image1, name: "John Doe", location: "New York, USA", message: "This product changed my life! Excellent service and support." },
    { id: 2, image: image2, name: "Jane Smith", location: "London, UK", message: "Amazing experience! Highly recommend to everyone." },
    {
        id: 3,
        image: image3,
        name: "Alice Johnson",
