            ...
            <div className="grid grid-cols-3 gap-10 items-center place-content-center">
                <div className="flex flex-col gap-10 bg-light-gray/50 dark:bg-dark-gray/30 p-10 rounded-lg">
                    ...
                    <div className="flex gap-4 group">
                        ...
                        <div className="space-y-1">
                            <p className="hover:text-light-deep hover:dark:text-dark-hoverLink transition-opacity duration-300 ease-in-out transform">Address goes here,</p>
                            <p className="hover:text-light-deep hover:dark:text-dark-hoverLink transition-opacity duration-300 ease-in-out transform">Address goes here,</p>
                        </div>
                    </div>
                ...
                <div className="w-full col-span-2 bg-light-gray/50 dark:bg-dark-gray/30  p-10 rounded-lg">
                    <form action="#" method="post" className="space-y-10">
                        <div className="w-full grid grid-cols-2 gap-5">
                            <input className="border border-opacity-10 rounded bg-inherit py-1.5 px-4 focus:outline-none" type="text" name="name" id="name" placeholder="Name *" />
                            <input className="border border-opacity-10 rounded bg-inherit py-1.5 px-4 focus:outline-none" type="email" name="email" id="email" placeholder="Email *" />
                        </div>
                        <div className="w-full grid grid-cols-1 gap-5">
                            <input className="border border-opacity-10 rounded bg-inherit py-1.5 px-4 focus:outline-none" type="text" name="subject" id="subject" placeholder="Subject *" />
                        </div>
                        <div className="w-full grid grid-cols-1 gap-5">
                            <input
