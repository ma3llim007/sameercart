...
const ProductDetails = () => {
    ...
    const handleDragEnd = e => {
        ...
        if (Math.abs(difference) > 50) {
            setCurrentImage(prev => (difference > 0 ? (prev === 0 ? selectedVariant?.images.length - 1 : prev - 1) : prev === selectedVariant?.images.length - 1 ? 0 : prev + 1));
        }
    };
                ...
                <section className="w-full my-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div className="w-full flex-grow relative">
                                <img
                                    ...
                                    className={`rounded-lg border border-gray-300 w-full h-auto transition-opacity duration-500 ease-in-out opacity-100 ${
                                        productData?.productType === "variable" && isDragging ? "cursor-grabbing" : "cursor-default"
                                    }`}
                                />
                        ...
                        <div className="flex flex-col p-2 space-y-3">
                            <h1 className="text-3xl font-semibold text-center lg:text-start">{capitalizeWords(productData?.productName)}</h1>
                                    ...
                                    <div key={groupName}>
                                        ...
                                        <div className="flex gap-4 justify-start">
                                            ...
                                            >
                                                ...
                                                {formattedVariantGroup[groupName].map(value => (
                                                    <option
                                                        key={`${groupName}-${value}`}
                                                        value={value}
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <Button className="text-base Primary" title="Add To Cart" onClick={handleAddToCart} disabled={quantity < 1}>
