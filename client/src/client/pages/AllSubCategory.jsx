...
const AllSubCategory = () => {
    ...
    const { subcategories, page: responsePage, totalPages } = data?.data || {};

    if (isLoading) return <Loader />;
    return (
        <>
            <Banner title={"Sub Category"} image={bannerImage}>
                <Breadcrumb>
                    ...
                    <div className="grid grid-cols-1 justify-items-center items-center py-6 px-3 gap-4 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-3">
                        {subcategories?.map(subcategory => (
                            ...
                            >
                                ...
                                />
                                <Button className="Primary btnXl font-responsive mt-4">
                                    <Link
