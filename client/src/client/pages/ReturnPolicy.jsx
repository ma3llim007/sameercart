            ...
            <Container>
                <section className="w-full my-10">
                    <div className="w-full p-4">
                        <h1 className="text-4xl font-bold text-dark-light mb-6">Return Policy</h1>
                        ...
                        <h2 className="text-2xl font-semibold text-dark-light mb-4">Eligibility for Returns</h2>
                        ...
                        <h2 className="text-2xl font-semibold text-dark-light mb-4">Non-Returnable Items</h2>
                        ...
                        <h2 className="text-2xl font-semibold text-dark-light mb-4">How to Initiate a Return</h2>
                        ...
                        <ol className="list-decimal list-inside mb-6">
                            <li>
                                ...
                                <a href="mailto:mohdsameer68257@gmail.com" className="text-dark-light hover:underline mx-2">
                                    mohdsameer68257@gmail.com
                                </a>
                                or call
                                <a href="tel:+9885191161" className="text-dark-light hover:underline mx-2">
                                    +91 98851 91161
                                </a>
                                to receive your return authorization.
                            </li>
                            <li>
                                <strong>Prepare Your Item</strong>: Ensure that the item is securely packaged in its original packaging, along with
                                all tags and accessories.
                            </li>
                            <li>
                                <strong>Ship the Item</strong>: Use the return label provided by our team, or ship to the following address at your
                                own cost:
                        ...
                        <h2 className="text-2xl font-semibold text-dark-light mb-4">Refunds</h2>
                        <p className="text-lg mb-6">
                            Once your return is received and inspected, we will send you an email to notify you of the approval or rejection of your
                            refund. Approved refunds will be processed and applied to your original method of payment within
                            <strong>7-10 business days</strong>.
                        </p>

                        <h2 className="text-2xl font-semibold text-dark-light mb-4">Exchanges</h2>
                        <p className="text-lg mb-6">
                            If you wish to exchange an item, please contact our customer service to arrange an exchange for a different size, color,
                            or product. Exchanges are subject to stock availability.
                        </p>

                        <h2 className="text-2xl font-semibold text-dark-light mb-4">Damaged or Defective Items</h2>
                        <p className="text-lg mb-6">
                        ...
                        <h2 className="text-2xl font-semibold text-dark-light mb-4">Return Shipping Costs</h2>
                        <ul className="list-disc list-inside mb-6">
                            <li>
                        ...
                        <h2 className="text-2xl font-semibold text-dark-light mb-4">International Returns</h2>
                        <p className="text-lg mb-6">
                            For international returns, shipping fees are non-refundable, and customers are responsible for any customs or import
                            duties incurred.
                        </p>

                        <h2 className="text-2xl font-semibold text-dark-light mb-4">Contact Us</h2>
                        ...
                        <ul className="list-disc list-inside">
                            <li>
                                ...
                                <a href="mailto:mohdsameer68257@gmail.com" className="text-dark-light hover:underline">
                                    mohdsameer68257@gmail.com
                                </a>
                            </li>
                            <li>
                                <strong className="mr-2">Phone:</strong>
                                <a href="tel:+123456789" className="text-dark-light hover:underline">
                                    +123-456-789
                                </a>
                            </li>
                            <li>
