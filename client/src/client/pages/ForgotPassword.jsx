...
const ForgotPassword = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Reset Your Password - SameerCart</title>
                <meta name="description" content="Forgot your password? Request a password reset on SameerCart and regain access to your account." />
                ...
                <section className="w-full my-10">
                    <div className="max-w-lg mx-auto border-2 border-gray-700 px-5 py-10 rounded-2xl shadow-2xl bg-gray-800 space-y-2 text-white">
                        ...
                        <form className="space-y-5" onSubmit={handleSubmit(data => mutate(data))}>
                            ...
                            <Button
                                isPending={isPending}
                                className="w-full bg-blue-600 hover:bg-blue-700 text-white text-xl font-semibold p-6 rounded-lg transition duration-300 ease-in-out transform"
                            >
                                Send
                            </Button>
                        </form>
