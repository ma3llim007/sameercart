            ...
            <Container>
                <section className="w-full mb-5 mt-10 p-4">
                    ...
                    <p className="text-lg">
                        ...
                        <Link to={"/"}>http://localhost:5173/</Link>. If you do not agree with any part of these terms, please discontinue using our
                        website.
                    </p>
                </section>
                <section className="w-full mb-5 mt-10 p-4">
                    ...
                    <p className="text-lg">
                        ...
                        confidentiality of your account credentials and ensuring the information provided is accurate, complete, and up to date.
                ...
                <section className="w-full mb-5 mt-10 p-4">
                    ...
                    <p className="text-lg">
                        ...
                        due at the time of purchase, and we accept the following payment methods: online/offline. In the event of a stock issue or
                        unforeseen circumstances affecting your order, we will notify you promptly and offer alternative solutions, including the
                ...
                <section className="w-full mb-5 mt-10 p-4">
                    ...
                    <p className="text-lg">
                        ...
                        location. Once an item has been shipped, the risk of loss or damage passes to the buyer. Please ensure that your shipping
                ...
                <section className="w-full mb-5 mt-10 p-4">
                    ...
                    <p className="text-lg">
                        ...
                        . Refunds will be processed within 7 business days of receiving the returned item, and the amount will be credited back to
                ...
                <section className="w-full mb-5 mt-10 p-4">
                    ...
                    <p className="text-lg">
                        ...
                        but are not limited to, engaging in fraud, distributing malware, violating intellectual property rights, or using our services
                ...
                <section className="w-full mb-5 mt-10 p-4">
                    ...
                    <p className="text-lg">
                        ...
                        SameerCart and is protected under copyright, trademark, and other applicable intellectual property laws. You may not use,
                ...
                <section className="w-full mb-5 mt-10 p-4">
                    ...
                    <p className="text-lg">
                        ...
                        that all content is error-free or up-to-date. To the fullest extent permitted by law, SameerCart is not liable for any direct,
                        indirect, incidental, or consequential damages arising from the use or inability to use our website, services, or products.
                    </p>
                </section>
                ...
                <section className="w-full mb-5 mt-10 p-4">
                    ...
                    <p className="text-lg">
                        ...
                        Privacy Policy. We encourage you to read our <Link to={"/privacy-policy"}>Privacy Policy</Link> to understand how we collect,
                ...
                <section className="w-full mb-5 mt-10 p-4">
                    ...
                    <p className="text-lg">
                        ...
                        notice, for any reason, including but not limited to violations of these Terms and Conditions. Upon termination, all
                ...
                <section className="w-full mb-5 mt-10 p-4">
                    ...
                    <p className="text-lg">
                        ...
                        to the exclusive jurisdiction of the courts located within India/Telanagana to resolve any legal matter arising from these
                        terms.
                    </p>
                </section>
                <section className="w-full mb-5 mt-10 p-4">
                    ...
                    <p className="text-lg">
                        ...
                        will be effective immediately upon posting on this page. Your continued use of the website constitutes acceptance of any
                        modifications. We encourage you to review this page regularly to stay informed of any changes.
                    </p>
                </section>
            </Container>
        </>
