                ...
                <section className="w-full my-10 p-4">
                    <div className="w-full space-y-8">
                        ...
                        <p className="text-lg mb-6">
                            ...
                            website or make a purchase from us. Please read this policy carefully. If you do not agree with the terms of this Privacy Policy, please do not access the Site.
                        </p>
                        ...
                        <div className="w-full space-y-2">
                            ...
                            <p className="text-lg mb-2">We do not sell or rent your personal information to third parties. However, we may share your information in the following situations:</p>
                            <ul className="list-disc space-y-2">
                                <li className="ml-6">
                                    <strong>Service Providers:</strong> We may employ third-party companies and individuals to facilitate our Service (“Service Providers”), provide the Service on our
                                    behalf, perform Service-related services, or assist us in analyzing how our Service is used. These third parties may have access to your Personal Information only
                                    to perform these tasks on our behalf and are obligated not to disclose or use it for any other purpose.
                                </li>
                                <li className="ml-6">
                                    <strong>Legal Requirements:</strong> We may disclose your information if required to do so by law or in response to valid requests by public authorities (e.g., a
                        ...
                        <div className="w-full space-y-2">
                            ...
                            <p className="text-lg mb-2">Depending on your location, you may have the following rights regarding your personal information:</p>
                            <ul className="list-disc space-y-2">
                                <li className="ml-6">The right to access, update, or delete the information we have on you.</li>
                                <li className="ml-6">The right to withdraw consent at any time where we rely on your consent to process your personal information.</li>
                        ...
                        <div className="w-full space-y-2">
                            ...
                            <p className="text-lg mb-2">
                                Our Site may contain links to third-party websites that are not operated by us. If you click on a third-party link, you will be directed to that third party’s site. We
                                strongly advise you to review the Privacy Policy and terms of service of every site you visit.
                            </p>
                        </div>
                        <div className="w-full space-y-2">
                            <h2 className="text-2xl font-bold text-light-blue dark:text-dark-light mb-6">Children’s Privacy</h2>
                            <p className="text-lg mb-2">
                                Our services are not directed to individuals under the age of 13, and we do not knowingly collect personal information from children under 13. If we become aware that
                                we have collected personal information from a child under 13, we will take steps to delete such information.
                            </p>
                        </div>
                        <div className="w-full space-y-2">
                            <h2 className="text-2xl font-bold text-light-blue dark:text-dark-light mb-6">Changes to This Privacy Policy</h2>
                            <p className="text-lg mb-2">
                                We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page. You are advised to review this
