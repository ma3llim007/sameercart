...
const Login = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Login to Your Account - SameerCart</title>
                <meta name="description" content="Log in to your SameerCart account to track orders, manage your profile, and access exclusive deals." />
                <meta name="keywords" content="login, user login, sign in, SameerCart account, ecommerce login" />
                <meta property="og:title" content="Login to Your Account - SameerCart" />
                <meta property="og:description" content="Access your SameerCart account securely and manage your orders." />
                <meta property="og:url" content="https://sameercart.com/login" />
